...
\caption{Method overview. \method{} is a sequence-only predictor that combines frozen ESM2-t33 residue embeddings, amino-acid one-hot features and relative-position features; warm-starts from a P4.6 \backbone{} checkpoint; freezes shared TCN blocks; trains low-rank SDR, LDR, terminal-IDR and internal-IDR adapters with a residue-level MoE gate; and produces calibrated disorder probabilities through three-seed score averaging and validation-fitted Platt calibration.}
\label{fig:method}
\end{figure*}
